...
async def startgmute(event):
    ...
    if event.fwd_from:
        ...
        await event.edit("Putting Dick馃崋 馃挦 In Son mouth!!")
    ...
    try:
        ...
        await event.edit("Son Can't speek now.... Filled His Mouth With Cum馃槈")
...
async def endgmute(event):
    ...
    try:
        ...
        await event.edit("Son Feeling Good..... Now speak馃崋馃崋")
