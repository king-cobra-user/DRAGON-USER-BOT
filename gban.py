...
async def gspider(userbot):
    ...
    if not sender.id == me.id:
        ...
        friday = await lol.reply("Gbanning This Retard DumbAss馃榿馃榿")
    ...
    await friday.edit(f"Global Ban Is Coming ! Wait And Watch You bitch馃槑馃敟")
    ...
    try:
        ...
        return await friday.edit(f"**Something W3NT Wrong 馃**")
    ...
    if user:
        ...
        if user.id == 1100231654:
            ...
            return await friday.edit(
                ...
                f"**Didn't , Your Father Teach You ? That You Cant Gban your creator馃槕馃槕馃枙**"
...
async def gspider(userbot):
    ...
    try:
        ...
        return await friday.edit("Someting Went Wrong 馃")
...
async def handler(rkG): 
   ...
   if rkG.user_joined or rkG.user_added:      
       ...
       try:       	         from userbot.modules.sql_helper.gmute_sql import is_gmuted
